...
public class ConfigActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Mode3 = (RadioButton) findViewById(R.id.radioButton3);
		Mode4 = (RadioButton) findViewById(R.id.radioButton4);
	...
	protected void onResume() {
		...
		CheckBoxUseFTDISerial
				.setChecked(app.CommunicationTypeMW == App.COMMUNICATION_TYPE_SERIAL_FTDI
		...
		if (CheckBoxUseFTDISerial.isChecked()) {
			...
			RadioOtherChips
					.setChecked(app.CommunicationTypeMW == App.COMMUNICATION_TYPE_SERIAL_OTHERCHIPS);
		}
		...
		EditTextSerialBaudRateMW.setText(String
				.valueOf(app.SerialPortBaudRateMW));
	...
	public void SaveSettingsOnClick(View v) {
		...
		app.RefreshRate = Integer.parseInt(EditTextRefreshRate.getText()
				.toString());
		app.MapCenterPeriod = Integer.parseInt(EditTextMapCenterPeriod
				.getText().toString());
		...
		app.SerialPortBaudRateMW = Integer.parseInt(EditTextSerialBaudRateMW
				.getText().toString());
