...
import com.lizhy.Sky.frsky.FrskyProtocol;
import com.lizhy.Sky.helpers.Functions;
import com.lizhy.Sky.helpers.Notifications;
import com.lizhy.Sky.helpers.SoundManager;
import com.lizhy.Sky.helpers.TTS;
import com.lizhy.Sky.helpers.VarioSoundClass;
import com.lizhy.Sky.mw.MultiWii220;
import com.lizhy.Sky.mw.MultiWii230;
import com.lizhy.Sky.mw.MultirotorData;
...
public class App extends Application  {
	...
	public void SelectProtocol() {//选择所用的飞控协议
	...
	public void SaveSettings(boolean quiet) {//保存设置
	...
	private void prepareSounds() {//预置音效
	...
	public void ForceLanguage() {//设置语言
	...
	private void FrskyToMW() {//遥控向飞控传输数据
	...
	public void OpenInfoOnClick(View v) {
		{
			LogUtil.d("aaa", "OpenInfoOnClick " + v.getTag().toString());
