...
public class RadioActivity extends SherlockActivity {
    ...
    private Runnable update = new Runnable() {
        ...
        public void run() {
            ...
            if (app.RadioMode == 4) {
                SV1.SetPosition(app.mw.rcRoll, app.mw.rcPitch);
                SV2.SetPosition(app.mw.rcYaw, app.mw.rcThrottle);
            }

            if (app.RadioMode == 3) {
                SV1.SetPosition(app.mw.rcRoll, app.mw.rcThrottle);
                SV2.SetPosition(app.mw.rcYaw, app.mw.rcPitch);
            }
            ...
            String a = "Throttle:" + String.valueOf(app.mw.rcThrottle);//将舵量值编入字符串输出
