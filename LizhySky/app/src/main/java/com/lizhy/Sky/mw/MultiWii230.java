...
public class MultiWii230 extends MultirotorData {
	...
	public void evaluateCommand(byte cmd, int dataSize) {
		...
		default:
			LogUtil.e("aaa", "Error command - unknown replay " + String.valueOf(icmd));
		...
		while (communication.dataAvailable()) {
			try {
				try {
					...
					c = 0;
					LogUtil.e("aaa", "Read Error " + e.getMessage().toString());

					// TODO inform about refresh rate to low
					break;

				}
				// LogUtil.d("21",String.valueOf(c));
				if (c_state == IDLE) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see MultirotorData#SendRequestMSP_SET_MISC(int,
	...
	public void SendRequestMSP_SET_RAW_RC(int[] channels8) {
		...
		LogUtil.d("aaa", "RC:" + String.valueOf(rcRoll) + " " + String.valueOf(rcPitch) + " " + String.valueOf(rcYaw) + " " + String.valueOf(rcThrottle) + " " + String.valueOf(rcAUX1) + " " + String.valueOf(rcAUX2) + " " + String.valueOf(rcAUX3) + " " + String.valueOf(rcAUX4));
